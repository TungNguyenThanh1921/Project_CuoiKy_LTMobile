...
void InitServer(String ipAddress) {
  // Initialize the server connection or any other setup required
  // before starting the chat application.
  // You can implement this method based on your specific server setup.
}
